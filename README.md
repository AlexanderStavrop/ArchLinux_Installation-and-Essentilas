...
| Matlab          | <a href="https://www.mathworks.com/downloads/web_downloads/">Download</a> the installer<br />                                                               \# unzip -X -K "matlab.zip"<br />                                                                                                                           **In case the installer fails to open**<br />                                                                                                               \# rm ./bin/glnxa64/libfreetype.so*<br />                                                                                                                   \# export LD_PRELOAD=/lib64/libfreetype.so<br />                                                                                                           \# ./install<br />                                                                                                                                         \# Select to download **every** products that has **MATLAB** in and also every other necessary                   |

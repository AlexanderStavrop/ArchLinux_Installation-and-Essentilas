...
|:----------------|:------------------------------------------------------------------------------------------------------------------|:------------:|
| CopyQ           | ***Download***<br />                                                                                                                                                                                                                                                                                            \# paru copyq<br />                                                                                                                                                                                                                                                                                             ***Configuration File***<br />                                                                                                                                                                                                                                                                                  Add the config file in the **~/.cofig/copyq/** directory<br />                                                                                                                                                                                                                                                  ***Shortcut***<br />                                                                                                                                                                                                                                                                                            Open copyQ and navigate to **File -> Preferences -> Shortcuts**<br />                                                                                                                                                                                                                                           Add **ctrl + `** as **show/hide main menu**<br />                                                                                                                                                                                                                                                               ***If copyQ doesn't Autostart***<br />                                                                                                                                                                                                                                                                          Navigate to **System Settings -> Startup and Shutdown -> Autostart**<br />                                                                                                                                                                                                                                      On the bottom, select **add** and then **add application** and search for copyQ                                   |![copyq.conf](https://github.com/AlexanderStavrop/ArchLinux_Installation-and-Essentilas/files/12137321/copyq.txt)                                                                                                                                                                                                             |
...
| Notion          | ***Download***<br />                                                                                                                                                 \# paru notion-app<br />                                                                                                                                                 Download the **Aur** package                                                                                       |      -     |
...
|     App Name       |                                                  Command                                                                  |
|:-------------------|:--------------------------------------------------------------------------------------------------------------------------|
| visual studio Code | ***Download***<br />                                                                                                                                                \# paru visual-studio-code<br />                                                                                                                                    ***General configuration***<br />                                                                                                                                    On the bottom left, press the **Gear** icon and select **settings**<br />                                                                                            Search for "wordwrap"<br />                                                                                                                                          *Editor: Word Wrap* &rarr; "on"<br />                                                                                                                                ***Github Copilot***<br />                                                                                                                                          On the left panel, press the **Extension** icon<br />                                                                                                                Downlaod "Github Copilot"<br />                                                                                                                                      ***Arduino***<br />                                                                                                                                                  \# paru arduino<br />                                                                                                                                                In VsCode, on the left panel, press the **Extension** icon<br />                                                                                                    Downlaod "Arduino"<br />                                                                                                                                            Downlaod "C/C++"<br />                                                                                                                                              On the bottom right press **Select Programmer** and select the correct programmers<br />                                                                            On the bottom right press **Select board Type** and download the "Arduino AVR Board" and after select the correct board<br />                                        On the bottom right press **Select Serial Port** and select the correct serial port<br />                                                                            */dev/ttyUSB0: Permission denied*<br />                                                                                                                              \# sudo usermod -a -G uucp $USER<br />                                                                                                                              Reboot<br />                                                                                                                                                        *Error in code*<br />                                                                                                                                                Upload a piece of code to arduino even if errors appear<br />                                                                                                        After that on the bottom right press **linux** and change it to "arduino"<br />                                                                                      ***Latex***<br />                                                                                                                                                    On the left panel, press the **Extension** icon<br />                                                                                                                Downlaod "Latex Workshop" by "James Yu"<br />                                                                                                                        Downlaod "Code Spell Checker" and "Greek - Code Spell Checker"<br />                                                                                                Press **F1** and search for "Show Spell Checker Configuration Info"<br />                                                                                            In the **User** tab check **Greek** and enable it for "User"                                                              |

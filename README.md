...
| Yt-dlp          | ***Download***<br />                                                                                                                                                 \# paru yt-dlp<br />                                                                                                                                                 ***Configuration***<br />                                                                                                                                             \# sudo mkdir ~/.config/yt-dlp<br />                                                                                                                                 \# sudo mv ~/Downloads/config ~/.config/yt-dlp/                                                                     |[config](https://github.com/AlexanderStavrop/ArchLinux_Installation-and-Essentilas/files/10914543/config.txt)                                                                   |

### Programming / Editors
|     App Name    |                                                  Command                                                          |
|:----------------|:------------------------------------------------------------------------------------------------------------------|
| Arduino         | ***Download***<br />                                                                                                                                                 \# paru arduino                                                                                                   |
| Clion           | ***Download***<br />                                                                                                                                                 <a href="https://www.jetbrains.com/clion/download/#section=linux">Download</a> <br />                                                                               Tools -> Create Desktop Entity                                                                                    |

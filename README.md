...
|     App Name       |                                                  Command                                                                  |
|:-------------------|:--------------------------------------------------------------------------------------------------------------------------|
| visual studio Code | ***Download***<br />                                                                                                                                                \# paru visual-studio-code<br />                                                                                                                                    ***General configuration***<br />                                                                                                                                    On the bottom left, press the **Gear** icon and select **settings**<br />                                                                                            Search for "wordwrap"<br />                                                                                                                                          *Editor: Word Wrap* &rarr; "on"<br />                                                                                                                                ***Github Copilot***<br />                                                                                                                                          On the left panel, press the **Extension** icon<br />                                                                                                                Downlaod "Github Copilot"<br />                                                                                                                                      ***Arduino***<br />                                                                                                                                                  On the left panel, press the **Extension** icon<br />                                                                                                                Downlaod "Arduino"<br />                                                                                                                                            Downlaod "C/C++"<br />                                                                                                                                              On the bottom right press **Select board Type** and download  the "Arduino AVR Board"<br />                                                                          ***Latex***<br />                                                                                                                                                    On the left panel, press the **Extension** icon<br />                                                                                                                Downlaod "Latex Workshop" by "James Yu"<br />                                                                                                                        Downlaod "Code Spell Checker" and "Greek - Code Spell Checker"<br />                                                                                                Press **F1** and search for "Show Spell Checker Configuration Info"<br />                                                                                            In the **User** tab check **Greek** and enable it for "User"                                                              |
